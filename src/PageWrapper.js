                     ...
                     <div className="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
                         <ul className="nav navbar-nav flex-child-menu menu-left">
                             ...
                             <li className="dropdown first">
                                 <Link to='/' className="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown">
                                 Home
                                 </Link>
                                 
                             </li>
                             <li className="dropdown first">
                                 <Link to='blog' className="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown">
                                 BLOG
                                 </Link>
